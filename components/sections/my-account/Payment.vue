...
const fetchDetail = async (id: any) => {
  ...
  try {
    const response = await fetch(`https://cms.berkahcapitalcredit.com/api/v1/loans/${id}`, {
      method: "GET",
      headers: {
...
const handlePayment = async () => {
  ...
  try {
    ...
    const response = await fetch("https://cms.berkahcapitalcredit.com/api/v1/loans/pay", {
      method: "POST",
