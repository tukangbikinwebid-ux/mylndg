...
<template>
  <div class="relative py-2">
    <button
      class="outline-none bg-transparent p-2.5 rounded-full text-dark-600 dark:text-dark hover:bg-gray-100 dark:hover:bg-gray-800"
      @click="
        (event) => {
          changeTheme(event);
        }
    ...
    >
      ...
      >
        <ul class="flex flex-col" @click="isOpen = false">
          <li
            class="flex select-none cursor-pointer items-center gap-3 px-2 py-2 rounded-md transition hover:bg-gray-100 dark:hover:bg-gray-800 text-dark-600 dark:text-dark-200"
